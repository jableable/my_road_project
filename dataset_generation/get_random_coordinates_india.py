...
while len(list_of_crossings)<=100:
    ...
    if type(goal) is str:
        ...
        while zoom1_crossings <= 1 and counter1<=10:            
            ...
            zoom1_crossings = return_crossings(zoom1_lat,zoom1_lon,step = zoom1_step, big_step = zoom1_step)
            counter1 += 1
            ...
            if type(zoom1_crossings) is str:
                ...
                while zoom2_crossings <= 1 and counter2<=15:                    
                    ...
                    zoom2_crossings = return_crossings(zoom2_lat,zoom2_lon,step = zoom2_step, big_step = zoom2_step)
                    counter2 += 1
